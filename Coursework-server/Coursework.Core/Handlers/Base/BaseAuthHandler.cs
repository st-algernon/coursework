...
internal abstract class BaseAuthHandler
{
    ...
    protected BaseAuthHandler(AppDbContext db, IJwtConfiguration jwtConfiguration)
    {
        Db = db;
    ...
    protected string GenerateAccessToken(User user) 
    {
        ...
        var jwt = new JwtSecurityToken(
            ...
            expires: now.Add(TimeSpan.FromMinutes(_jwtConfiguration.AccessTokenLifetimeInMinutes)),
    ...
    protected RefreshToken CreateRefreshToken(User user, string accessToken)
    {
        ...
        var refreshToken = new RefreshToken()
        {
            ...
            ExpiryDate = DateTime.UtcNow.AddDays(_jwtConfiguration.RefreshTokenLifetimeInDays),
            IsRevoked = false,
